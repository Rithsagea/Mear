...
export const TetrioOptions = t.type({ // room vs match options
  version: t.number,
  seed_random: t.boolean,
  seed: t.number,
  g: t.number, // gravity (?)
  stock: t.number,
  countdown: t.boolean,
  countdown_count: t.number,
  countdown_interval: t.number,
  precountdown: t.number,
  prestart: t.number,
  mission: t.string, // Room name
  mission_type: t.string, //TODO literal
  zoominto: t.string, //TODO literal
  slot_counter1: t.string, // TODO define, might be partial
  slot_counter2: t.string, // TODO define
  slot_counter3: t.string, // TODO define
  slot_counter5: t.string, // TODO define
});
